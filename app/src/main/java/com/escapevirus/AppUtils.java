...
public class AppUtils {
    ...
    public static String myShot(Activity activity) {
        ...
        File SpicyDirectory = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/btkittys_vip/");
        SpicyDirectory.mkdirs();//如果没有这个目录就创建

        String filename = Environment.getExternalStorageDirectory().getAbsolutePath() + "/btkittys_vip/game_screen.jpg";
