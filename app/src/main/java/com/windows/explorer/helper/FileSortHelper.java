...
public class FileSortHelper {
    ...
    private Comparator cmpDate = new FileComparator() {
        @Override
        public int doCompare(FileInfo object1, FileInfo object2) {
            return longToCompareInt(object2.getModifiedDate() - object1.getModifiedDate());
        }
    };
    ...
    private Comparator cmpType = new FileComparator() {
        @Override
        public int doCompare(FileInfo object1, FileInfo object2) {
            int result = Util.getExtFromFilename(object1.getFileName()).compareToIgnoreCase(
                    Util.getExtFromFilename(object2.getFileName()));
            if (result != 0)
                return result;

            return Util.getNameFromFilename(object1.getFileName()).compareToIgnoreCase(
                    Util.getNameFromFilename(object2.getFileName()));
        }
    };
}
