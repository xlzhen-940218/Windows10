...
public class RequestHttpUtils {
    ...
    public static <T> void postData(final Context context, String url, Map<String, String> map, final Class<?> cls, final NetWorkResponseListener listener) {
        OkHttpClient mOkHttpClient = new OkHttpClient();
        FormBody.Builder builder;
        builder = mapToFormBody(map);
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (finalJsonObject != null) {
                                ...
                                if (finalJsonObject.getString("errno").equals("0")) {
                                    if (listener != null) {

                                        if (cls != String.class) {
                                            T bean = (T) FastJSONParser.getBean(finalJsonObject.toString(), cls);
    ...
    @SuppressWarnings("unchecked")
    private static FormBody.Builder mapToFormBody(Map<String, String> map) {
